 ...
 */
public class MeuCarango_Extrator {

    public static void main(String [] args) throws IOException {
        File inputDirectory=new File("C:\\Users\\rodol_000\\CIn\\RI\\paginas_positivas\\meu_carango");
        ...
        for(File htmlFile : files){
            ...
            BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\rodol_000\\CIn\\RI\\MeuCarango_Extrator\\"+nameOfFile+".txt"));
            bw.write("Nome do html:"+nameOfFile);
            bw.newLine();

            Element description=doc.getElementsByAttributeValue("itemprop","description").first();
            Elements list=description.getElementsByClass("dis-t brd-b dotted");
            ArrayList<String> dados=new ArrayList<String>();
            for(Element el:list){
                dados.add(el.getElementsByTag("strong").text());
            }
            ...
            String[] titulo=doc.getElementsByClass("col-9 vehicleTitle").text().split(" ");
            ...
            String combustivel=dados.get(2);//doc.getElementById("ctl00_ContentPlaceHolder1_lblCombustivel").text();
            //String Cambio=doc.getElementById("ctl00_ContentPlaceHolder1_lblCambio").text();
            String Cambio=dados.get(3);
            String km=dados.get(1);
