 ...
 */
public class pastoreExtrator {

    public static void main(String [] args) throws IOException {
        File inputDirectory=new File("C:\\Users\\rodol_000\\CIn\\RI\\paginas_positivas\\pastore");
        ...
        for(File htmlFile : files){
            ...
            BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\rodol_000\\CIn\\RI\\Pastorerec_Extrator\\"+nameOfFile+".txt"));
            ...
            Element details=doc.getElementsByClass("descriptions-vehicle concerta").first();
            Element ulconcerta=details.getElementsByClass("concerta").first();
            ulconcerta.getElementsByTag("p");
            String phtml=ulconcerta.html();
